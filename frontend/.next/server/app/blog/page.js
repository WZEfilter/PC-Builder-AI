...
The remaining budget provides flexibility for peripherals or immediate upgrades, ensuring you can create a complete gaming setup without exceeding your $800 budget. This build represents the best possible gaming performance at this price point in 2025.`}],g="All"===t?h:h.filter(e=>e.category===t),f=e=>{s(e),d(e.content)},b=async e=>{e.preventDefault(),c&&(p(!0),u(""),setTimeout(()=>{p(!1)},3e3))};return n?(0,o.jsxs)("div",{className:"min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900",children:[o.jsx("header",{className:"bg-slate-800 shadow-lg border-b border-slate-700",children:o.jsx("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:(0,o.jsxs)("div",{className:"flex justify-between items-center py-6",children:[(0,o.jsxs)("div",{className:"flex items-center",children:[o.jsx("button",{onClick:()=>{s(null),d("")},className:"text-blue-400 hover:text-blue-300 mr-4",children:"← Back to Blog"}),o.jsx("h1",{className:"text-2xl font-bold text-white",children:"PC Builder AI"})]}),(0,o.jsxs)("nav",{className:"hidden md:flex space-x-8",children:[o.jsx("a",{href:"/",className:"text-slate-300 hover:text-white",children:"Home"}),o.jsx("a",{href:"/ask-ai",className:"text-slate-300 hover:text-white",children:"Ask AI"}),o.jsx("a",{href:"/blog",className:"text-blue-400 font-medium",children:"Blog"})]})]})})}),o.jsx("main",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:(0,o.jsxs)("div",{className:"bg-slate-800 rounded-2xl shadow-xl border border-slate-700 overflow-hidden",children:[o.jsx("div",{className:"h-64 bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center",children:o.jsx("h1",{className:"text-3xl md:text-4xl font-bold text-white text-center px-6",children:n.title})}),(0,o.jsxs)("div",{className:"p-8",children:[(0,o.jsxs)("div",{className:"flex items-center mb-6",children:[o.jsx("span",{className:"bg-blue-900 text-blue-300 text-sm font-medium px-3 py-1 rounded border border-blue-700",children:n.category}),o.jsx("span",{className:"text-slate-400 ml-4",children:new Date(n.date).toLocaleDateString()})]}),l&&o.jsx("div",{className:"prose prose-invert max-w-none",children:o.jsx("div",{className:"text-slate-300 leading-relaxed",dangerouslySetInnerHTML:{__html:l.replace(/\n/g,"<br>").replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\*(.*?)\*/g,"<em>$1</em>").replace(/^# (.*?)$/gm,'<h1 class="text-2xl font-bold text-white mt-8 mb-4">$1</h1>').replace(/^## (.*?)$/gm,'<h2 class="text-xl font-bold text-white mt-6 mb-3">$1</h2>').replace(/^### (.*?)$/gm,'<h3 class="text-lg font-bold text-white mt-4 mb-2">$1</h3>').replace(/\[([^\]]+)\]\(([^)]+)\)/g,'<a href="$2" class="text-blue-400 hover:text-blue-300" target="_blank" rel="noopener noreferrer">$1</a>')}})})]})]})})]}):(0,o.jsxs)("div",{className:"min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900",children:[o.jsx("header",{className:"bg-slate-800 shadow-lg border-b border-slate-700",children:o.jsx("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:(0,o.jsxs)("div",{className:"flex justify-between items-center py-6",children:[(0,o.jsxs)("div",{className:"flex items-center",children:[o.jsx("button",{onClick:()=>e.push("/"),className:"text-blue-400 hover:text-blue-300 mr-4",children:"← Back"}),o.jsx("h1",{className:"text-2xl font-bold text-white",children:"PC Builder AI"})]}),(0,o.jsxs)("nav",{className:"hidden md:flex space-x-8",children:[o.jsx("a",{href:"/",className:"text-slate-300 hover:text-white",children:"Home"}),o.jsx("a",{href:"/ask-ai",className:"text-slate-300 hover:text-white",children:"Ask AI"}),o.jsx("a",{href:"/blog",className:"text-blue-400 font-medium",children:"Blog"})]})]})})}),(0,o.jsxs)("main",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12",children:[(0,o.jsxs)("div",{className:"bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 mb-12 text-white text-center",children:[o.jsx("h2",{className:"text-3xl md:text-4xl font-bold mb-4",children:"Build Your Dream PC with AI"}),o.jsx("p",{className:"text-blue-100 mb-8 text-lg max-w-2xl mx-auto",children:"Get personalized PC build recommendations powered by AI. Tell us your budget and use case, and we'll create the perfect build for you."}),(0,o.jsxs)("div",{className:"flex flex-col sm:flex-row gap-4 justify-center",children:[o.jsx("button",{onClick:()=>e.push("/"),className:"bg-white text-blue-600 px-8 py-3 rounded-lg hover:bg-gray-100 transition-colors font-medium",children:"Generate PC Build"}),o.jsx("button",{onClick:()=>e.push("/ask-ai"),className:"bg-blue-700 text-white px-8 py-3 rounded-lg hover:bg-blue-800 transition-colors font-medium border border-blue-500",children:"Ask AI Questions"})]})]}),(0,o.jsxs)("div",{className:"text-center mb-12",children:[o.jsx("h1",{className:"text-4xl md:text-5xl font-bold text-white mb-6",children:"PC Building Blog"}),o.jsx("p",{className:"text-xl text-slate-300 max-w-3xl mx-auto",children:"Expert insights, component reviews, and building guides to help you make the best PC decisions."})]}),o.jsx("div",{className:"flex flex-wrap justify-center gap-4 mb-12",children:["All","Gaming","Components","GPU","CPU","Guide","Motherboard"].map(e=>o.jsx("button",{onClick:()=>i(e),className:`px-4 py-2 rounded-full text-sm font-medium transition-colors ${e===t?"bg-blue-600 text-white":"bg-slate-700 text-slate-300 hover:bg-slate-600 border border-slate-600"}`,children:e},e))}),o.jsx("div",{className:"grid md:grid-cols-2 lg:grid-cols-3 gap-8",children:g.map(e=>(0,o.jsxs)("article",{className:"bg-slate-800 rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-shadow border border-slate-700",children:[o.jsx("div",{className:"h-48 bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center",children:(0,o.jsxs)("div",{className:"text-center",children:[o.jsx("div",{className:"text-white font-semibold text-lg mb-2",children:e.category}),"build"===e.type&&(0,o.jsxs)("div",{className:"text-blue-200 text-sm",children:["$",e.budget," ",e.use_case," build"]})]})}),(0,o.jsxs)("div",{className:"p-6",children:[(0,o.jsxs)("div",{className:"flex items-center mb-3",children:[o.jsx("span",{className:"bg-blue-900 text-blue-300 text-xs font-medium px-2.5 py-0.5 rounded border border-blue-700",children:e.category}),o.jsx("span",{className:"text-slate-400 text-sm ml-auto",children:new Date(e.date).toLocaleDateString()})]}),o.jsx("h2",{className:"text-xl font-bold text-white mb-3 line-clamp-2",children:e.title}),o.jsx("p",{className:"text-slate-300 mb-4 line-clamp-3",children:e.excerpt}),o.jsx("button",{onClick:()=>f(e),className:"text-blue-400 hover:text-blue-300 font-medium text-sm",children:"Read More →"})]})]},e.id))}),(0,o.jsxs)("div",{className:"mt-20 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white text-center",children:[o.jsx("h2",{className:"text-2xl font-bold mb-4",children:"Stay Updated"}),o.jsx("p",{className:"text-blue-100 mb-6",children:"Get the latest PC building tips and component recommendations delivered to your inbox."}),m?o.jsx("div",{className:"text-green-300 font-medium",children:"✓ Thank you for subscribing!"}):(0,o.jsxs)("form",{onSubmit:b,className:"flex max-w-md mx-auto",children:[o.jsx("input",{type:"email",value:c,onChange:e=>u(e.target.value),placeholder:"Enter your email",className:"flex-1 px-4 py-3 rounded-l-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-300",required:!0}),o.jsx("button",{type:"submit",className:"bg-blue-700 text-white px-6 py-3 rounded-r-lg hover:bg-blue-800 transition-colors",children:"Subscribe"})]})]})]})]})}},8159:(e,t,i)=>{"use strict";i.r(t),i.d(t,{$$typeof:()=>n,__esModule:()=>a,default:()=>l});var o=i(5153);let r=(0,o.createProxy)(String.raw`/app/frontend/src/app/blog/page.js`),{__esModule:a,$$typeof:n}=r,s=r.default,l=s},4553:(e,t,i)=>{"use strict";i.r(t),i.d(t,{default:()=>s,metadata:()=>n});var o=i(4656),r=i(7686),a=i.n(r);i(5023);let n={title:"PC Builder AI - Build Your Perfect PC",description:"AI-powered PC builder that recommends optimized builds based on your budget and use case. Get personalized PC recommendations with real product links.",keywords:"PC builder, AI, computer build, gaming PC, custom PC, budget PC",authors:[{name:"PC Builder AI"}],creator:"PC Builder AI",publisher:"PC Builder AI",formatDetection:{email:!1,address:!1,telephone:!1},openGraph:{title:"PC Builder AI - Build Your Perfect PC",description:"AI-powered PC builder that recommends optimized builds based on your budget and use case.",url:"https://pcbuilderai.com",siteName:"PC Builder AI",images:[{url:"https://pcbuilderai.com/og-image.png",width:1200,height:630}],locale:"en_US",type:"website"},twitter:{card:"summary_large_image",title:"PC Builder AI - Build Your Perfect PC",description:"AI-powered PC builder that recommends optimized builds based on your budget and use case.",images:["https://pcbuilderai.com/og-image.png"]},robots:{index:!0,follow:!0,googleBot:{index:!0,follow:!0,"max-video-preview":-1,"max-image-preview":"large","max-snippet":-1}}};function s({children:e}){return o.jsx("html",{lang:"en",children:o.jsx("body",{className:a().className,children:e})})}},5023:()=>{}};var t=require("../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e),o=t.X(0,[261],()=>i(6807));module.exports=o})();