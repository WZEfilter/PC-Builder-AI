(()=>{var e={};e.id=404,e.ids=[404],e.modules={2934:e=>{"use strict";e.exports=require("next/dist/client/components/action-async-storage.external.js")},5403:e=>{"use strict";e.exports=require("next/dist/client/components/request-async-storage.external")},4580:e=>{"use strict";e.exports=require("next/dist/client/components/request-async-storage.external.js")},4749:e=>{"use strict";e.exports=require("next/dist/client/components/static-generation-async-storage.external")},5869:e=>{"use strict";e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},399:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},2408:(e,t,i)=>{"use strict";i.r(t),i.d(t,{GlobalError:()=>s.a,__next_app__:()=>m,originalPathname:()=>u,pages:()=>c,routeModule:()=>p,tree:()=>d});var r=i(7096),a=i(6132),o=i(7284),s=i.n(o),n=i(2564),l={};for(let e in n)0>["default","tree","pages","GlobalError","originalPathname","__next_app__","routeModule"].indexOf(e)&&(l[e]=()=>n[e]);i.d(t,l);let d=["",{children:["blog",{children:["__PAGE__",{},{page:[()=>Promise.resolve().then(i.bind(i,8159)),"/app/frontend/src/app/blog/page.js"]}]},{}]},{layout:[()=>Promise.resolve().then(i.bind(i,4553)),"/app/frontend/src/app/layout.js"],"not-found":[()=>Promise.resolve().then(i.t.bind(i,9291,23)),"next/dist/client/components/not-found-error"]}],c=["/app/frontend/src/app/blog/page.js"],u="/blog/page",m={require:i,loadChunk:()=>Promise.resolve()},p=new r.AppPageRouteModule({definition:{kind:a.x.APP_PAGE,page:"/blog/page",pathname:"/blog",bundlePath:"",filename:"",appPaths:[]},userland:{loaderTree:d}})},4209:(e,t,i)=>{Promise.resolve().then(i.t.bind(i,3579,23)),Promise.resolve().then(i.t.bind(i,619,23)),Promise.resolve().then(i.t.bind(i,1459,23)),Promise.resolve().then(i.t.bind(i,3456,23)),Promise.resolve().then(i.t.bind(i,847,23)),Promise.resolve().then(i.t.bind(i,7303,23))},7925:(e,t,i)=>{Promise.resolve().then(i.bind(i,7146))},1190:()=>{},3854:(e,t,i)=>{"use strict";e.exports=i(2337).vendored["react-ssr"].ReactJsxRuntime},1018:(e,t,i)=>{"use strict";e.exports=i(7804)},7146:(e,t,i)=>{"use strict";i.r(t),i.d(t,{default:()=>s});var r=i(3854),a=i(1018),o=i(4218);function s(){let e=(0,a.useRouter)(),[t,i]=(0,o.useState)("All"),[s,n]=(0,o.useState)(null),[l,d]=(0,o.useState)(""),[c,u]=(0,o.useState)(""),[m,p]=(0,o.useState)(!1),h=[{id:1,title:"Best Gaming PC Builds Under $1000 in 2025",excerpt:"Discover the most powerful gaming PC builds you can get for under $1000, optimized for 1080p gaming.",date:"2025-01-15",category:"Gaming",slug:"gaming-pc-under-1000",type:"build",budget:1e3,use_case:"gaming",content:`# Best Gaming PC Builds Under $1000 in 2025
...
This $685 gaming build proves that you don't need to spend a fortune to enjoy excellent PC gaming. With smart component choices and careful budgeting, you can build a machine that delivers outstanding performance while leaving room for future improvements. Whether you're playing the latest AAA titles or competitive esports games, this build will exceed your expectations.`},{id:2,title:"DDR4 vs DDR5: Which RAM Should You Choose?",excerpt:"Complete comparison of DDR4 and DDR5 memory, including performance, pricing, and compatibility.",date:"2025-01-12",category:"Components",slug:"ddr4-vs-ddr5",type:"article",content:`# DDR4 vs DDR5: Which RAM Should You Choose?
...
If you're building a mid-range system or upgrading an existing one, DDR4 is the way to go. But if you're aiming for a top-tier, future-proof rig, DDR5 is worth the investment. Whichever you choose, make sure it aligns with your overall PC build goals. Happy building!`},{id:3,title:"RTX 4070 vs RTX 4060 Ti: GPU Comparison",excerpt:"In-depth comparison of NVIDIA's mid-range graphics cards for 1440p gaming.",date:"2025-01-10",category:"GPU",slug:"rtx-4070-vs-4060-ti",type:"article",content:`# RTX 4070 vs RTX 4060 Ti: GPU Comparison
...
Ultimately, both platforms will deliver exceptional performance for modern computing needs. Your choice should be based on your specific requirements, budget, and long-term upgrade plans.`},{id:5,title:"Complete PC Building Guide for Beginners",excerpt:"Step-by-step guide to building your first PC, from component selection to assembly.",date:"2025-01-05",category:"Guide",slug:"pc-building-guide-beginners",type:"article",content:`# Complete PC Building Guide for Beginners
...
Use software like HWMonitor to ensure your CPU and GPU temperatures are within safe ranges (typically under 80\xb0C under load).
...
Most importantly, enjoy the process! There's something special about pressing the power button on a PC you built yourself and seeing it come to life. Welcome to the PC Master Race!`},{id:6,title:"Best Budget Motherboards for 2025",excerpt:"Top motherboard recommendations for different CPU platforms and budgets.",date:"2025-01-03",category:"Motherboard",slug:"best-budget-motherboards-2025",type:"article",content:`# Best Budget Motherboards for 2025
...
The motherboards recommended in this guide offer the best balance of features, quality, and value for 2025. Choose based on your specific needs, budget, and future upgrade plans, and you'll have a solid foundation for your PC build.`},{id:7,title:"Best Streaming PC Build Under $1500",excerpt:"Perfect PC build for content creators and streamers who need performance and reliability.",date:"2025-01-01",category:"Gaming",slug:"streaming-pc-build-1500",type:"build",budget:1500,use_case:"streaming",content:`# Best Streaming PC Build Under $1500
...
The remaining budget can be allocated to essential streaming peripherals like a quality microphone, webcam, or lighting setup, ensuring you have everything needed to create engaging content for your audience.`},{id:8,title:"Budget Gaming PC Build Under $800",excerpt:"Entry-level gaming PC that can handle modern games at 1080p without breaking the bank.",date:"2024-12-28",category:"Gaming",slug:"budget-gaming-pc-800",type:"build",budget:800,use_case:"gaming",content:`# Budget Gaming PC Build Under $800
...
The remaining budget provides flexibility for peripherals or immediate upgrades, ensuring you can create a complete gaming setup without exceeding your $800 budget. This build represents the best possible gaming performance at this price point in 2025.`}],g=["All","Gaming","Components","GPU","CPU","Guide","Motherboard"],f="All"===t?h:h.filter(e=>e.category===t),y=e=>{n(e),d(e.content)},b=async e=>{e.preventDefault(),c&&(p(!0),u(""),setTimeout(()=>{p(!1)},3e3))};return s?(0,r.jsxs)("div",{className:"min-h-screen bg-slate-50",children:[r.jsx("header",{className:"bg-white shadow-sm border-b",children:r.jsx("div",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8",children:(0,r.jsxs)("div",{className:"flex justify-between items-center py-4",children:[(0,r.jsxs)("div",{className:"flex items-center",children:[r.jsx("button",{onClick:()=>{n(null),d("")},className:"text-blue-600 hover:text-blue-700 mr-4 font-medium",children:"← Back to Blog"}),r.jsx("h1",{className:"text-xl font-bold text-gray-900",children:"PC Builder AI"})]}),(0,r.jsxs)("nav",{className:"hidden md:flex space-x-6",children:[r.jsx("a",{href:"/",className:"text-gray-600 hover:text-gray-900",children:"Home"}),r.jsx("a",{href:"/ask-ai",className:"text-gray-600 hover:text-gray-900",children:"Ask AI"}),r.jsx("a",{href:"/blog",className:"text-blue-600 font-medium",children:"Blog"})]})]})})}),r.jsx("main",{className:"max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8",children:(0,r.jsxs)("article",{className:"bg-white rounded-lg shadow-sm border overflow-hidden",children:[(0,r.jsxs)("div",{className:"px-8 py-6 border-b border-gray-100",children:[(0,r.jsxs)("div",{className:"flex items-center mb-3",children:[r.jsx("span",{className:`text-xs font-medium px-2 py-1 rounded-full ${"Gaming"===s.category?"bg-green-100 text-green-800":"Components"===s.category?"bg-blue-100 text-blue-800":"GPU"===s.category?"bg-purple-100 text-purple-800":"CPU"===s.category?"bg-red-100 text-red-800":"Guide"===s.category?"bg-orange-100 text-orange-800":"bg-gray-100 text-gray-800"}`,children:s.category}),r.jsx("span",{className:"text-gray-500 text-sm ml-3",children:new Date(s.date).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})}),(0,r.jsxs)("span",{className:"text-gray-400 text-sm ml-3",children:["• ",Math.ceil(s.content.length/1e3)," min read"]})]}),r.jsx("h1",{className:"text-2xl md:text-3xl font-bold text-gray-900 mb-4 leading-tight",children:s.title}),r.jsx("div",{className:"flex items-center text-sm text-gray-500 mb-4",children:(0,r.jsxs)("div",{className:"flex items-center",children:[r.jsx("div",{className:"w-8 h-8 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-xs mr-3",children:"AI"}),(0,r.jsxs)("div",{children:[r.jsx("div",{className:"font-medium text-gray-900 text-sm",children:"PC Builder AI"}),r.jsx("div",{className:"text-gray-500 text-xs",children:"Expert PC Building Assistant"})]})]})}),"build"===s.type&&(0,r.jsxs)("div",{className:"flex items-center gap-2 text-xs",children:[(0,r.jsxs)("span",{className:"bg-blue-100 text-blue-800 px-2 py-1 rounded-full font-medium",children:["Budget: $",s.budget]}),(0,r.jsxs)("span",{className:"bg-green-100 text-green-800 px-2 py-1 rounded-full font-medium",children:["Use Case: ",s.use_case]})]})]}),r.jsx("div",{className:"px-8 py-6 bg-gradient-to-r from-blue-50 to-purple-50 border-b border-blue-200",children:(0,r.jsxs)("div",{className:"flex items-start",children:[r.jsx("div",{className:"w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-sm mr-4 flex-shrink-0",children:"AI"}),(0,r.jsxs)("div",{children:[r.jsx("h3",{className:"text-base font-semibold text-gray-900 mb-2",children:"Need a Custom PC Build?"}),r.jsx("p",{className:"text-gray-600 text-sm mb-4",children:"This article gives you great insights, but every build is unique. Let our AI create a personalized PC build tailored to your exact budget, use case, and preferences."}),(0,r.jsxs)("div",{className:"flex flex-col sm:flex-row gap-3",children:[r.jsx("button",{onClick:()=>e.push("/"),className:"bg-blue-600 text-white px-5 py-2 rounded-md hover:bg-blue-700 transition-colors font-medium text-sm",children:"\uD83E\uDD16 Generate My PC Build"}),r.jsx("button",{onClick:()=>e.push("/ask-ai"),className:"bg-white text-blue-600 px-5 py-2 rounded-md hover:bg-gray-50 transition-colors font-medium border border-blue-600 text-sm",children:"\uD83D\uDCAC Ask AI Questions"})]})]})]})}),(0,r.jsxs)("div",{className:"px-8 py-6",children:[l&&r.jsx("div",{className:"max-w-none",children:r.jsx("div",{className:"text-gray-700 leading-relaxed text-sm",style:{lineHeight:"1.6",fontSize:"14px"},dangerouslySetInnerHTML:{__html:l.replace(/\n\n/g,'</p><p class="mb-3">').replace(/\n/g,"<br>").replace(/\*\*(.*?)\*\*/g,'<strong class="font-medium text-gray-900">$1</strong>').replace(/\*(.*?)\*/g,'<em class="italic text-gray-800">$1</em>').replace(/^# (.*?)$/gm,'<h1 class="text-lg font-semibold text-gray-900 mt-6 mb-3 pb-2 border-b border-gray-200">$1</h1>').replace(/^## (.*?)$/gm,'<h2 class="text-base font-semibold text-gray-900 mt-5 mb-3">$1</h2>').replace(/^### (.*?)$/gm,'<h3 class="text-sm font-medium text-gray-900 mt-4 mb-2">$1</h3>').replace(/\[([^\]]+)\]\(([^)]+)\)/g,'<a href="$2" class="text-blue-600 hover:text-blue-700 underline text-sm" target="_blank" rel="noopener noreferrer">$1</a>').replace(/^(.*)$/gm,'<p class="mb-3 text-sm">$1</p>')}})}),(0,r.jsxs)("div",{className:"mt-6 pt-5 border-t border-gray-200",children:[r.jsx("h3",{className:"text-base font-bold text-gray-900 mb-4",children:"Related Articles"}),r.jsx("div",{className:"grid md:grid-cols-2 gap-4",children:h.filter(e=>e.id!==s.id&&e.category===s.category).slice(0,2).map(e=>(0,r.jsxs)("div",{className:"bg-gray-50 rounded-lg p-4 hover:bg-gray-100 transition-colors cursor-pointer",onClick:()=>y(e),children:[r.jsx("h4",{className:"font-medium text-gray-900 mb-2 text-sm line-clamp-2 hover:text-blue-600 transition-colors",children:e.title}),r.jsx("p",{className:"text-gray-600 text-xs mb-3 line-clamp-2",children:e.excerpt}),r.jsx("div",{className:"text-blue-600 hover:text-blue-700 font-medium text-xs",children:"Read More →"})]},e.id))})]})]})]})})]}):(0,r.jsxs)("div",{className:"min-h-screen bg-slate-50",children:[r.jsx("header",{className:"bg-white shadow-sm border-b",children:r.jsx("div",{className:"max-w-6xl mx-auto px-4 sm:px-6 lg:px-8",children:(0,r.jsxs)("div",{className:"flex justify-between items-center py-4",children:[(0,r.jsxs)("div",{className:"flex items-center",children:[r.jsx("button",{onClick:()=>e.push("/"),className:"text-blue-600 hover:text-blue-700 mr-4 font-medium",children:"← Back to PC Builder"}),r.jsx("h1",{className:"text-2xl font-bold text-gray-900",children:"PC Builder AI Blog"})]}),(0,r.jsxs)("nav",{className:"hidden md:flex space-x-6",children:[r.jsx("a",{href:"/",className:"text-gray-600 hover:text-gray-900",children:"Home"}),r.jsx("a",{href:"/ask-ai",className:"text-gray-600 hover:text-gray-900",children:"Ask AI"}),r.jsx("a",{href:"/blog",className:"text-blue-600 font-medium",children:"Blog"})]})]})})}),r.jsx("main",{className:"max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8",children:(0,r.jsxs)("div",{className:"grid lg:grid-cols-3 gap-8",children:[(0,r.jsxs)("div",{className:"lg:col-span-2",children:[(0,r.jsxs)("div",{className:"bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-6 mb-8 text-white",children:[r.jsx("h2",{className:"text-2xl font-bold mb-3",children:"Need a Custom PC Build?"}),r.jsx("p",{className:"text-blue-100 mb-4",children:"Get personalized PC build recommendations powered by AI. Tell us your budget and use case, and we'll create the perfect build for you."}),(0,r.jsxs)("div",{className:"flex flex-col sm:flex-row gap-3",children:[r.jsx("button",{onClick:()=>e.push("/"),className:"bg-white text-blue-600 px-6 py-2 rounded-md hover:bg-gray-50 transition-colors font-medium",children:"Generate PC Build"}),r.jsx("button",{onClick:()=>e.push("/ask-ai"),className:"bg-blue-700 text-white px-6 py-2 rounded-md hover:bg-blue-800 transition-colors font-medium",children:"Ask AI Questions"})]})]}),(0,r.jsxs)("div",{className:"mb-8",children:[r.jsx("h1",{className:"text-4xl font-bold text-gray-900 mb-4",children:"PC Building Insights & Guides"}),r.jsx("p",{className:"text-lg text-gray-600",children:"Expert advice, component reviews, and complete build guides to help you make the best PC decisions."})]}),r.jsx("div",{className:"flex flex-wrap gap-2 mb-8 pb-4 border-b",children:g.map(e=>r.jsx("button",{onClick:()=>i(e),className:`px-4 py-2 rounded-full text-sm font-medium transition-colors ${e===t?"bg-blue-600 text-white":"bg-gray-100 text-gray-700 hover:bg-gray-200"}`,children:e},e))}),r.jsx("div",{className:"space-y-6",children:f.map((e,t)=>r.jsx("article",{className:`bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow cursor-pointer ${0===t?"border-blue-200":""}`,onClick:()=>y(e),children:(0,r.jsxs)("div",{className:"p-6",children:[(0,r.jsxs)("div",{className:"flex items-center mb-4",children:[r.jsx("span",{className:`text-xs font-medium px-2.5 py-1 rounded-full ${"Gaming"===e.category?"bg-green-100 text-green-800":"Components"===e.category?"bg-blue-100 text-blue-800":"GPU"===e.category?"bg-purple-100 text-purple-800":"CPU"===e.category?"bg-red-100 text-red-800":"Guide"===e.category?"bg-orange-100 text-orange-800":"bg-gray-100 text-gray-800"}`,children:e.category}),r.jsx("span",{className:"text-gray-500 text-sm ml-3",children:new Date(e.date).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})}),(0,r.jsxs)("span",{className:"text-gray-400 text-sm ml-3",children:["• ",Math.ceil(e.content.length/1e3)," min read"]})]}),r.jsx("h2",{className:"text-xl font-bold text-gray-900 mb-3 hover:text-blue-600 transition-colors",children:e.title}),r.jsx("p",{className:"text-gray-600 mb-4 line-clamp-3",children:e.excerpt}),"build"===e.type&&(0,r.jsxs)("div",{className:"flex items-center mb-4 text-sm text-gray-500",children:[(0,r.jsxs)("span",{className:"bg-gray-100 px-2 py-1 rounded mr-2",children:["Budget: $",e.budget]}),(0,r.jsxs)("span",{className:"bg-gray-100 px-2 py-1 rounded",children:["Use Case: ",e.use_case]})]}),(0,r.jsxs)("div",{className:"inline-flex items-center text-blue-600 hover:text-blue-700 font-medium",children:["Read More",r.jsx("svg",{className:"w-4 h-4 ml-1",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:r.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})]})]})},e.id))})]}),r.jsx("div",{className:"lg:col-span-1",children:(0,r.jsxs)("div",{className:"sticky top-8 space-y-6",children:[(0,r.jsxs)("div",{className:"bg-white rounded-lg shadow-sm border p-4",children:[r.jsx("h3",{className:"text-lg font-semibold text-gray-900 mb-3",children:"Search"}),(0,r.jsxs)("div",{className:"relative",children:[r.jsx("input",{type:"text",placeholder:"Search articles...",className:"w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 pl-10"}),r.jsx("svg",{className:"w-4 h-4 text-gray-400 absolute left-3 top-3",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:r.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"})})]})]}),(0,r.jsxs)("div",{className:"bg-white rounded-lg shadow-sm border p-4",children:[r.jsx("h3",{className:"text-lg font-semibold text-gray-900 mb-4",children:"Popular Posts"}),r.jsx("div",{className:"space-y-3",children:f.slice(0,4).map(e=>(0,r.jsxs)("div",{className:"flex items-start space-x-3 cursor-pointer hover:bg-gray-50 p-2 rounded transition-colors",onClick:()=>y(e),children:[r.jsx("div",{className:"w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded flex-shrink-0"}),(0,r.jsxs)("div",{children:[r.jsx("h4",{className:"text-sm font-medium text-gray-900 line-clamp-2 hover:text-blue-600 transition-colors",children:e.title}),r.jsx("p",{className:"text-xs text-gray-500 mt-1",children:new Date(e.date).toLocaleDateString()})]})]},e.id))})]}),(0,r.jsxs)("div",{className:"bg-white rounded-lg shadow-sm border p-4",children:[r.jsx("h3",{className:"text-lg font-semibold text-gray-900 mb-4",children:"Categories"}),r.jsx("div",{className:"space-y-2",children:g.filter(e=>"All"!==e).map(e=>r.jsx("button",{onClick:()=>i(e),className:`w-full text-left px-3 py-2 rounded text-sm transition-colors ${e===t?"bg-blue-100 text-blue-700":"text-gray-600 hover:bg-gray-50"}`,children:e},e))})]}),(0,r.jsxs)("div",{className:"bg-gradient-to-br from-blue-600 to-purple-600 rounded-lg p-6 text-white",children:[r.jsx("h3",{className:"text-lg font-semibold mb-3",children:"Stay Updated"}),r.jsx("p",{className:"text-blue-100 text-sm mb-4",children:"Get the latest PC building tips and reviews delivered to your inbox."}),m?r.jsx("div",{className:"text-green-200 font-medium text-sm",children:"✓ Thank you for subscribing!"}):(0,r.jsxs)("form",{onSubmit:b,className:"space-y-3",children:[r.jsx("input",{type:"email",value:c,onChange:e=>u(e.target.value),placeholder:"Enter your email",className:"w-full px-3 py-2 rounded text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300",required:!0}),r.jsx("button",{type:"submit",className:"w-full bg-blue-700 text-white py-2 rounded hover:bg-blue-800 transition-colors text-sm font-medium",children:"Subscribe"})]})]})]})})]})})]})}},8159:(e,t,i)=>{"use strict";i.r(t),i.d(t,{$$typeof:()=>s,__esModule:()=>o,default:()=>l});var r=i(5153);let a=(0,r.createProxy)(String.raw`/app/frontend/src/app/blog/page.js`),{__esModule:o,$$typeof:s}=a,n=a.default,l=n},4553:(e,t,i)=>{"use strict";i.r(t),i.d(t,{default:()=>n,metadata:()=>s});var r=i(4656),a=i(7686),o=i.n(a);i(5023);let s={title:"PC Builder AI - Build Your Perfect PC",description:"AI-powered PC builder that recommends optimized builds based on your budget and use case. Get personalized PC recommendations with real product links.",keywords:"PC builder, AI, computer build, gaming PC, custom PC, budget PC",authors:[{name:"PC Builder AI"}],creator:"PC Builder AI",publisher:"PC Builder AI",formatDetection:{email:!1,address:!1,telephone:!1},openGraph:{title:"PC Builder AI - Build Your Perfect PC",description:"AI-powered PC builder that recommends optimized builds based on your budget and use case.",url:"https://pcbuilderai.com",siteName:"PC Builder AI",images:[{url:"https://pcbuilderai.com/og-image.png",width:1200,height:630}],locale:"en_US",type:"website"},twitter:{card:"summary_large_image",title:"PC Builder AI - Build Your Perfect PC",description:"AI-powered PC builder that recommends optimized builds based on your budget and use case.",images:["https://pcbuilderai.com/og-image.png"]},robots:{index:!0,follow:!0,googleBot:{index:!0,follow:!0,"max-video-preview":-1,"max-image-preview":"large","max-snippet":-1}}};function n({children:e}){return r.jsx("html",{lang:"en",children:r.jsx("body",{className:o().className,children:e})})}},5023:()=>{}};var t=require("../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e),r=t.X(0,[261],()=>i(2408));module.exports=r})();