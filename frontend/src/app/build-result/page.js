...
export default function BuildResult() {
  ...
  const downloadAsMarkdown = () => {
    ...
    const markdown = `# PC Build Recommendation
...
`
    ...
    a.href = url
    a.download = `pc-build-${buildData.use_case}-${buildData.budget}.md`
  ...
  const shareOnTwitter = () => {
    ...
    const text = `Just got my AI-generated PC build for ${buildData.use_case} at $${buildData.budget}! Check out PC Builder AI for your perfect build.`
